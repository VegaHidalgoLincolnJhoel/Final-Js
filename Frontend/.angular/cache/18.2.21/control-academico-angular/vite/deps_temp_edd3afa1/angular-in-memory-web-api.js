...
var InMemoryBackendConfig = class _InMemoryBackendConfig {
  ...
  static {
    this.ɵfac = function InMemoryBackendConfig_Factory(__ngFactoryType__) {
...
var HttpClientBackendService = class _HttpClientBackendService extends BackendService {
  ...
  static {
    this.ɵfac = function HttpClientBackendService_Factory(__ngFactoryType__) {
...
var HttpClientInMemoryWebApiModule = class _HttpClientInMemoryWebApiModule {
  ...
  static {
    this.ɵfac = function HttpClientInMemoryWebApiModule_Factory(__ngFactoryType__) {
...
var InMemoryWebApiModule = class _InMemoryWebApiModule {
  ...
  static {
    this.ɵfac = function InMemoryWebApiModule_Factory(__ngFactoryType__) {
